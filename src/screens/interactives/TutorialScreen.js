		...
		<Onboarding
			pages={[
				...
				},
				{
					...
					subtitle:
						'Arraste o quadrado centrar para a esquerda para "não" e para a direita para "sim". Cada escolha trará suas próprias consequências.',
				},
				{
					backgroundColor: '#7159c1',
					image: <Image source={require('../../../assets/hidreletrica.jpg')} />,
				...
				},
				{
					...
					title: (
						<Text style={styles.text}>
							Leve seu <Text style={styles.bold}>estado</Text> à{' '}
							<Text style={styles.bold}>glória eterna</Text>!
						</Text>
					),
					subtitle:
						'Quando algum de seus atributos alcançar seu valor máximo ou mínimo, você ganhará ou perderá, respectivamente.',
				},
			]}
			onDone={() => {
